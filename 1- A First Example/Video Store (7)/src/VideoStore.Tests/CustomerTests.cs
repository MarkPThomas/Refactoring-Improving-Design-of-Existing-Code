...
namespace VideoStore.Tests
{
    ...
    public class CustomerTests
    {
        ...
        [Test]
        public void htmlstatement_with_0_movies()
        {
            string customerName = "Frank";
            Customer customer = new Customer(customerName);
            ...
            Assert.AreEqual(expected, customer.HtmlStatement());
        }
        ...
        [TestCase(4)]
        [TestCase(5)]
        public void htmlstatement_with_1_childrens_movie(int daysRented)
        {
            string customerName = "Frank";
            Customer customer = new Customer(customerName);
            string expected = $"<H1>Rentals for <em>{customerName}</em></h1><p>\n";
            ...
            double totalAmount = 0;
            addRentals_childrens_movie(1, daysRented, ref customer, ref expected, ref totalAmount, "<br>");

            int frequentRenterPoints = 1;

            expected += $"<P> You owe <em>{totalAmount}</em><p>\n" + $"On this rental you earned <em>{frequentRenterPoints}</em> frequent renter points<p>";
        ...
        [TestCase(3)]
        [TestCase(4)]
        public void htmlstatement_with_1_newRelease_movie(int daysRented)
        {
            string customerName = "Frank";
            Customer customer = new Customer(customerName);
            string expected = $"<H1>Rentals for <em>{customerName}</em></h1><p>\n";
            ...
            double totalAmount = 0;
            addRentals_newRelease_movie(1, daysRented, ref customer, ref expected, ref totalAmount, "<br>");
        ...
        [TestCase(3)]
        [TestCase(4)]
        public void htmlstatement_with_1_regular_movie_(int daysRented)
        {
            string customerName = "Frank";
            Customer customer = new Customer(customerName);
            string expected = $"<H1>Rentals for <em>{customerName}</em></h1><p>\n";
            ...
            double totalAmount = 0;
            addRentals_regular_movie(1, daysRented, ref customer, ref expected, ref totalAmount, "<br>");
        ...
        [TestCase(3)]
        [TestCase(4)]
        public void htmlstatement_with_3_childrens_movie_2_regular_movie_3_newRelease_movies(int daysRented)
        {
            string customerName = "Frank";
            Customer customer = new Customer(customerName);
            string expected = $"<H1>Rentals for <em>{customerName}</em></h1><p>\n";
            ...
            double totalAmount = 0;
            addRentals_3_childrens_movie_3_regular_movie_2_newRelease_movie(daysRented, ref customer, ref expected, ref totalAmount, "<br>");
        ...
        private void addRentals_3_childrens_movie_3_regular_movie_2_newRelease_movie(
           ...
           string suffix = "")
        {
            addRentals_childrens_movie(3, daysRented, ref customer, ref expected, ref totalAmount, suffix);
            addRentals_regular_movie(2, daysRented, ref customer, ref expected, ref totalAmount, suffix);
            addRentals_newRelease_movie(3, daysRented, ref customer, ref expected, ref totalAmount, suffix);
        }
           ...
           if (numberOfMovies > 0)
            {
                ...
                expected += $"\t{snowWhite.Title}\t{thisAmount}{suffix}\n";
            }
           if (numberOfMovies > 1)
            {
                ...
                thisAmount = thisAmountChildrens(daysRented);
                totalAmount += thisAmount;
                expected += $"\t{aladdin.Title}\t{thisAmount}{suffix}\n";
            }
           if (numberOfMovies > 2)
            {
                ...
                thisAmount = thisAmountChildrens(daysRented);
                totalAmount += thisAmount;
                expected += $"\t{spongeBob.Title}\t{thisAmount}{suffix}\n";
            }
        }
        ...
        if (numberOfMovies > 0)
        {
            ...
            totalAmount += thisAmount;
            expected += $"\t{apollo13.Title}\t{thisAmount}{suffix}\n";
        }
        if (numberOfMovies > 1)
        {
            ...
            thisAmount = thisAmountRegular(daysRented);
            totalAmount += thisAmount;
            expected += $"\t{apocalypseNow.Title}\t{thisAmount}{suffix}\n";
        }
    }
        ...
        if (numberOfMovies > 0)
        {
            ...
            totalAmount += thisAmount;
            expected += $"\t{dieHard12.Title}\t{thisAmount}{suffix}\n";
         }
        if (numberOfMovies > 1)
        {
            ...
            thisAmount = thisAmountNewRelease(daysRented);
            totalAmount += thisAmount;
            expected += $"\t{phantomShark.Title}\t{thisAmount}{suffix}\n";
        }
        if (numberOfMovies > 2)
        {
            ...
            thisAmount = thisAmountNewRelease(daysRented);
            totalAmount += thisAmount;
            expected += $"\t{youveGotMail.Title}\t{thisAmount}{suffix}\n";
        }
    }
